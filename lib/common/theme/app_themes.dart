  ...
  return [
    AppTheme(
      ...
      options: AppColors(
        ...
        popupMenuBackgroundColor: const Color(0xFFFFFFFF),
        finishColor: const Color(0xFF2DCD71),
      ),
    ),
    AppTheme(
      id: "dark_theme",
      ...
      options: AppColors(
        ...
        backgroundDarkColor: const Color(0xff2f2f2f),
        primaryColor: const Color(0xFF2196F3),
        ...
        whiteColor: const Color(0xFFFFFFFF),
        popupMenuBackgroundColor: const Color(0xFF090909),
        finishColor: const Color(0xFF2DCD71),
      ),
    ),
  ];
