      ...
      body: BlocBuilder<SessionBloc, SessionState>(
        builder: (context, state) {
          if (state.status.isLoading) {
            ...
            List<DateTime> dates = state.sessions.map((e) => DateUtils.dateOnly(e.routine.timestamp)).toList();
            List<Session> selectedSessions =
                state.sessions.where((element) => DateUtils.dateOnly(element.routine.timestamp) == DateUtils.dateOnly(_selectedDay)).toList();
            return Padding(
